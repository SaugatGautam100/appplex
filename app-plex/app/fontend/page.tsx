    ...
    <section className="bg-white pt-20 pb-10">
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        <div className="relative">
          <DottedGrid className="bottom-0 left-0 -translate-y-1/2" />
        ...
        <div className="relative h-[400px]">
          ...
          <Image src="/frontend-hero.png" alt="Developer's hands on a keyboard" layout="fill" objectFit="cover" className="z-10" />
        </div>
      </div>
      <div className="container mx-auto px-6 mt-12">
        <div className="h-1 bg-gray-200 rounded-full overflow-hidden">
          <div className="h-full bg-brand-purple" style={{ width: '30%' }}></div>
        </div>
      </div>
    </section>
);
...
const FrontendStack = () => (
    <section className="py-24 bg-gray-50/70">
        <div className="container mx-auto px-6 text-center">
            <h2 className="text-4xl font-bold text-brand-dark">Our frontend stack</h2>
            <div className="relative mt-16">
              <DottedGrid className="top-0 left-0 -translate-x-1/2 -translate-y-1/2" />
              <div className="grid md:grid-cols-3 gap-8">
                  <div className="bg-white p-8 rounded-lg shadow-sm border border-transparent hover:border-brand-purple transition-all">
                      <Image src="/logos/angular.svg" alt="Angular logo" width={48} height={48} className="mx-auto" />
                      <h3 className="mt-4 text-2xl font-semibold text-brand-dark">Angular</h3>
                      <p className="mt-2 text-gray-600">Robust code architecture, supported by a huge developer ecosystem and vast library.</p>
                  </div>
                  <div className="bg-white p-8 rounded-lg shadow-sm border border-transparent hover:border-brand-purple transition-all">
                      <Image src="/logos/react.svg" alt="React logo" width={48} height={48} className="mx-auto" />
                      <h3 className="mt-4 text-2xl font-semibold text-brand-dark">React</h3>
                      <p className="mt-2 text-gray-600">One of fastest and most powerful frameworks for building, scaling and maintaining a project.</p>
                  </div>
                  <div className="bg-white p-8 rounded-lg shadow-sm border border-transparent hover:border-brand-purple transition-all">
                      <Image src="/logos/vue.svg" alt="Vue.js logo" width={48} height={48} className="mx-auto" />
                      <h3 className="mt-4 text-2xl font-semibold text-brand-dark">Vue.js</h3>
                      <p className="mt-2 text-gray-600">A great fit for beautiful simplicity and highly performant single-page web applications.</p>
                  </div>
              </div>
              <DottedGrid className="bottom-0 right-0 translate-x-1/2 translate-y-1/2" />
            </div>
...
const PwaSection = () => (
    <section className="py-24 bg-white">
        <div className="container mx-auto px-6 grid md:grid-cols-3 gap-8 items-center">
            <h2 className="text-4xl font-bold text-brand-dark md:col-span-1">We also deliver PWA:</h2>
            <div className="md:col-span-2 bg-gray-50 p-10 rounded-lg relative">
                <DottedGrid className="bottom-0 right-0 translate-x-1/4 translate-y-1/4" />
                <div className="flex justify-between items-start">
                    <div>
                        <h3 className="text-2xl font-semibold text-brand-dark">Progressive Web Apps</h3>
                        <p className="mt-4 text-gray-600 max-w-xl">Progressive Web Apps offer the speed, reliability and security of the modern web, with the same features that have traditionally only been available to native apps. There’s a place for native app development, but it can be costly and time-consuming. PWA development allows rapid development and turnaround times, without compromising on the best of what web and mobile technologies have to offer.</p>
                    </div>
                    <a href="#" className="flex-shrink-0 ml-8 mt-1 inline-flex items-center gap-2 font-semibold text-brand-purple">
                        SEE CASE STUDY <ArrowRight />
                    </a>
                </div>
            </div>
        </div>
    ...
    <section className="bg-brand-purple text-white">
      <div className="container mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center relative">
        ...
        <div>
          ...
          <p className="mt-4 text-xl text-violet-200">Get help from Polcode's web development experts.</p>
  ...
  <section className="py-24 bg-white">
    <div className="container mx-auto px-6">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div>
          <Image src="/partner-combo-strike.svg" alt="Combo Strike Logo" width={150} height={40} className="grayscale" />
          <h3 className="mt-6 text-3xl font-bold text-brand-dark">Digital Marketing Agency Levels Up Their Gaming Influencer Platform</h3>
          <div className="mt-6 grid grid-cols-2 gap-8">
            <div><p className="text-sm uppercase text-gray-500">Industry</p><p className="font-semibold text-gray-800">Digital agencies</p></div>
            <div><p className="text-sm uppercase text-gray-500">Region</p><p className="font-semibold text-gray-800">Germany</p></div>
          </div>
          <div className="mt-6"><p className="text-sm uppercase text-gray-500">Technologies</p>
            <div className="mt-2 flex flex-wrap gap-3">
              {['Ruby', 'Node.js', 'Redux', 'Twitch', 'Ruby on Rails'].map(tech => (
                <span key={tech} className="px-4 py-1.5 border border-gray-300 rounded-full text-sm text-gray-700">{tech}</span>
              ))}
            </div>
          </div>
          <p className="mt-6 text-gray-600">ComboStrike is a full-service digital marketing agency for the gaming industry with offices in Berlin, Shanghai and Los Angeles. They work with some of the top video game publishers worldwide, including Sega, Tencent Games, Netease and Amazon Games Studios.</p>
        ...
        <div className="relative h-[500px] bg-brand-purple p-8">
            ...
            <Image src="/project-gaming.png" alt="Gaming platform interface" layout="fill" objectFit="contain" />
        </div>
      </div>
    ...
    <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
            <div className="relative h-[450px]">
                <div className="absolute inset-0 bg-brand-purple opacity-70 z-20"></div>
                <Image src="/hire-dev.png" alt="Developer working at a desk" layout="fill" objectFit="cover" className="z-10"/>
                <DottedGrid className="bottom-0 right-0 translate-x-1/4 translate-y-1/4" />
            </div>
            <div>
                <h2 className="text-4xl font-bold text-brand-dark">Hire frontend developers you can always trust</h2>
...
// --- Excellence Section ---
const ExcellenceCard = ({ icon, title, children }: {icon: ReactNode, title: string, children: ReactNode}) => (
  <div>
...
const Excellence = () => (
  <section className="py-24 bg-white">
    <div className="container mx-auto px-6 relative">
      ...
      <p className="mt-4 text-gray-600 max-w-2xl">Make your next web project go smoothly with our battle-tested web development services.</p>
      <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-12">
        <ExcellenceCard icon={<Zap size={32}/>} title="Agility">Our development teams use an agile approach to deliver continuous, quality results.</ExcellenceCard>
        <ExcellenceCard icon={<BookOpen size={32}/>} title="Planning">Get roadmaps and technical decisions made with accurate effort, cost and time estimates.</ExcellenceCard>
        <ExcellenceCard icon={<Star size={32}/>} title="Quality">We perform the latest in automated reviews to ensure we ship only the best quality code.</ExcellenceCard>
        <ExcellenceCard icon={<Heart size={32}/>} title="Skillset">Polcode developers use the latest trends, best practices and frameworks to get work done.</ExcellenceCard>
        <ExcellenceCard icon={<Search size={32}/>} title="Transparency">An open book of logged hours and see-through web development lifecycle.</ExcellenceCard>
        <ExcellenceCard icon={<Shuffle size={32}/>} title="Flexibility">We adapt to your workflow processes, project management tools and chat channels.</ExcellenceCard>
      </div>
    </div>
  </section>
);
...
const OnDemandCta = () => (
  <section className="py-20 bg-gray-50">
    <div className="container mx-auto px-6 text-center">
      <h2 className="text-4xl font-bold text-brand-dark">Developers on-demand</h2>
      <p className="mt-4 text-gray-600 max-w-xl mx-auto">Polcode gives you the flexibility to hire as many developers as you need, or let us run your whole project with a complete agile team.</p>
      <button className="mt-8 bg-brand-purple text-white font-semibold py-3 px-8 rounded-md hover:bg-violet-700 transition-colors">
