  ...
  return (
    <section className="relative py-16 md:py-24">
      ...
      <div className="container relative z-[1] text-center">
        <motion.h1
         className="text-[32px] md:text-[46px] leading-[1.12] font-semibold tracking-tight text-gray-900 dark:text-white"
         animate = {{
              y: 20,
            }}
            transition={{
         ...
         >
          Build <span
            ...
            className="text-gblue dark:text-gblue-dark"
          >delightful products
          </span> with a world‑class team
        </motion.h1>
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-3">
          ...
          <Link href="/projects" className="inline-flex items-center gap-2 bg-gray-100 dark:bg-white/5 hover:bg-gray-200/80 dark:hover:bg-white/10 text-gray-900 dark:text-gray-100 font-medium py-2.5 px-5 rounded-pill">
            <span className="material-symbols-rounded text-[20px]">play_circle</span> See our works
          </Link>
        </div>
      </div>
    </section >
